 ...
 * @returns
 */
export function parseFullEmojiResponseCallback(
  response: ParseFullEmojiResponse
): void {
 ...
 * @param response
 */
export function partialEmojiResponseCallback(
  response: PartialEmojiResponse
): void {
